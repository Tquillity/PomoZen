  ...
  return (
    <article className="w-full max-w-2xl mx-auto mt-12 mb-8 px-6 text-white/40 text-xs sm:text-sm leading-relaxed space-y-4">
      ...
      <p>
        ...
        <strong> offline</strong> and respects your privacy.
      </p>
      <p>
        Whether you are using the <strong>Pomodoro Technique</strong> for studying, coding, or writing, our 
        built-in <strong>white noise</strong> and nature sounds (Zen Mode) help block out distractions.
        Track your <strong>focus sessions</strong> without needing to create an account.
      </p>
    </article>
  );
};
