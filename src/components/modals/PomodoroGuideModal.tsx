      ...
      <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
        ...
        {isExpanded && (
          <div className="mt-4 space-y-4 text-sm leading-relaxed text-gray-200">
            ...
            <div>
              <p className="font-semibold text-[var(--theme-primary)] mb-2">What is the Pomodoro Technique?</p>
              <p className="text-gray-300">
            ...
            <div>
              <p className="font-semibold text-[var(--theme-primary)] mb-2">How to use PomoZen</p>
            ...
            <div>
              <p className="font-semibold text-[var(--theme-primary)] mb-2">Why choose PomoZen?</p>
              <p className="text-gray-300">
