    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Color Psychology">
      <div className="space-y-5 text-sm leading-relaxed text-gray-600">
        ...
        <ul className="space-y-4">
          <li><strong className="text-[var(--theme-primary)]">Pomodoro (Focus) – Soft warm red (#c15c5c)</strong><br/>Provides gentle arousal and urgency to overcome procrastination and enter flow, without the anxiety that bright red can trigger. Red is the traditional "tomato" color and increases attention to detail.</li>
          <li><strong className="text-[var(--theme-primary)]">Short Break – Refreshing mint-teal (#52a89a)</strong><br/>Quick emotional reset with nature/water associations. Green-blue hues are proven to reduce stress fastest and restore attention rapidly.</li>
          <li><strong className="text-[var(--theme-primary)]">Long Break – Deep indigo-blue (#2c5578)</strong><br/>Maximum calm, clarity, and recovery. Blue consistently lowers heart rate/cortisol and is rated the #1 color for sustained concentration and relaxation in workplace studies.</li>
        </ul>

        <p className="font-medium text-gray-800">This warm → refreshing → cool progression mirrors the natural energy cycle of the Pomodoro Technique itself.</p>

        <div className="pt-4 border-t border-gray-100">
          <p className="font-semibold mb-2 text-gray-700">Scientific sources:</p>
